class InvoiceItem
  ...
  def initialize(invoice_item_creation_hash, invoice_item_repository_object)
    ...
    @unit_price = invoice_item_hash = BigDecimal.new(invoice_item_hash[:unit_price], invoice_item_hash[:unit_price].length)/100
